...
export default function UserInfoCard() {
  ...
  const canEdit = session?.role === "company_admin";
  ...
  return (
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      ...
      <Modal isOpen={isOpen && canEdit} onClose={closeModal} className="max-w-[700px] m-4">
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          >
            ...
            <div className="flex items-center gap-3 px-1 mt-6 lg:justify-end">
              ...
              <Button size="sm" onClick={handleSave} disabled={isSubmitting || !hasChanged}>
